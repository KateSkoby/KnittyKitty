...
using KnittyKitty.Uno.ViewModels;
...
public sealed partial class MainPage : Page
{
    ...
    public MainPage()
    {
        ...
        ApplicationStorage.EnsureInitialized();

        Root.SizeChanged += Root_SizeChanged;
        Loaded += MainPage_Loaded;

        _dataPath = ApplicationStorage.DatabasePath;
    ...
    /// Применяет стартовую адаптивную раскладку после загрузки страницы.
